...
#define LED_GREEN_ON()			palClearPad(GPIOC, 4)
#define LED_GREEN_OFF()			palSetPad(GPIOC, 4)
#define LED_RED_ON()			palClearPad(GPIOC, 5)
#define LED_RED_OFF()			palSetPad(GPIOC, 5)
...
//WZQ
// #define MY_SPI_DEV				SPID3
// #define MY_SPI_GPIO_AF			GPIO_AF_SPI3
// #define MY_SPI_PORT_NSS			GPIOA
// #define MY_SPI_PIN_NSS			15
// #define MY_SPI_PORT_SCK			GPIOC
// #define MY_SPI_PIN_SCK			10
// #define MY_SPI_PORT_MOSI		GPIOC
// #define MY_SPI_PIN_MOSI			12
// #define MY_SPI_PORT_MISO		GPIOC
// #define MY_SPI_PIN_MISO			11

#define MINI_UART_BAUD			115200
#define MINI_UART_DEV			SD1     //UART1 3.3V   MIDDLE
#define MINI_UART_GPIO_AF		GPIO_AF_USART1
#define MINI_UART_TX_PORT		GPIOB
#define MINI_UART_TX_PIN		6
#define MINI_UART_RX_PORT		GPIOB
#define MINI_UART_RX_PIN		7

#define ENC_UART_BAUD			115200
#define ENC_UART_DEV			SD3     //UART3 5V     SIDE
#define ENC_UART_GPIO_AF		GPIO_AF_USART3
#define ENC_UART_TX_PORT		GPIOB
#define ENC_UART_TX_PIN		    10
#define ENC_UART_RX_PORT		GPIOB
#define ENC_UART_RX_PIN		    11

#define WATCH_UART_BAUD			115200
#define WATCH_UART_DEV			SD4     //UART4 3.3V     SPI3
#define WATCH_UART_GPIO_AF		GPIO_AF_UART4
#define WATCH_UART_TX_PORT		GPIOC
#define WATCH_UART_TX_PIN		10
#define WATCH_UART_RX_PORT		GPIOC
#define WATCH_UART_RX_PIN		11
